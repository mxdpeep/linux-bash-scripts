...
options="--vfs-cache-mode full --vfs-cache-max-age 12h --dir-cache-time 15m --buffer-size 256M --vfs-read-ahead 1024M --drive-chunk-size 256M --cache-dir /1TB/rclone --attr-timeout 3s --daemon"
